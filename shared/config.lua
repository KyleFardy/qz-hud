...
Config.UseMPH = true -- If Set To True, Will Display MPH, If Set To False Will Show KPH
...
Config.Logo = '/html/logo.png' -- The Logo Shown In The Top Right Of The Screen
